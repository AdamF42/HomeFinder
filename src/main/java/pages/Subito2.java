...
public class Subito2 implements Page, Cloneable {

    private static final Logger logger = LoggerFactory.getLogger(Subito2.class);
    ...
    public Subito2(String url, String baseUrl, RandomInterval interval, RandomInterval navigationInterval) {
    ...
    public Page getNextPage() {
        ...
        return new Subito2(baseUrl + url, baseUrl, interval, navigationInterval);
    }
    ...
    @Override
    public Subito2 clone() {
        return new Subito2(document.location(), baseUrl, interval, navigationInterval);
    }
